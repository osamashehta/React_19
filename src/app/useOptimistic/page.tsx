...
import HomePage from "@/component/onMutate/HomePage";
import Optimistic from "@/component/Optimistic/Optimistic";
...
export default async function Home() {
  ...
  return (
    <div className="container w-[95%] mx-auto my-12 ">
      <Optimistic mostRequestedProducts={mostRequestedProducts} token={token} guestId={guestId} />
    </div>
  );
}
